                        ...
                        <div class="">
                            <div class="animate__animated animate__fadeIn animate__delay-1s animate__faster col-lg-6 end-0 text-center justify-content-center flex-column mx-lg-0 mx-auto"
                                ...
                                <div class="card card-plain">
                                    <div id="contenedor-contenido" class="card-body">
                                        <div class="contenedor-form animate__animated animate__fadeIn d-lg-flex d-flex flex-column">
                                            <div class="card card-plain">
                                                                    ...
                                                                    @elseif ($img_repuesto)
                                                                        <a title="Ver imagen del repuesto"
                                                                            ...
                                                                            href="#"><i class="fas fa-image"
                                                                                style="font-size: 18px;" alt="img"></i></a>
                                                                    @else
                                                                        No hay imagen
                                                                    @endif
                                                                </span>
                                    ...
                                    <div class="animate__animated animate__fadeIn animate__delay-1s card-footer text-center pt-0 px-lg-4 px-1"
                                        style="padding: 0 5% !important;">
                                        <div class="d-flex justify-content-end"
                                            style="gap: 10px; padding: 0% 1.5rem 0.5% 0;">
                                            ...
                                            <div class="text-center">
                                                <a id="btn"
                                                    class="btn btn-primary w-100 mb-2">Siguiente</a>
                                            </div>
                                        </div>
                            ...
                            <div class="animate__animated animate__bounceInRight animate__fast col-6 d-lg-flex d-none h-100 my-auto position-absolute top-0 start-0 text-center justify-content-center flex-column"
                                style="padding: 0;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex flex-col mb-3">
                                    ...
                                    <div class="text-start">
                                        ...
                                        <div>
                                            <span style="background-color: rgba(218, 218, 218, 0.21); display: flex; justify-content: space-between; align-items: center;"
                                                type="text" name="repuesto"
                                                class="form-control text-start datos_pedido"
                                                placeholder="Repuesto"
                                                aria-label="Repuesto">{{ $repuesto }}
                                                ...
                                                @elseif ($img_repuesto)
                                                    <a title="Ver imagen del repuesto"
                                                            data-toggle="modal" data-target="#infoModal"
                                                            href="#"><i
                                                                class="fas fa-image" style="font-size: 18px;"></i></a>
                                                @else
                                                    No hay imagen
                                                @endif
                                            </span>
                                ...
                                <div class="flex flex-col mb-3">
                                    ...
                                    <div class="text-start">
                                        ...
                                        <textarea style="background-color: rgba(218, 218, 218, 0.21);" name="comentario"
                                            class="form-control text-center datos_pedido" placeholder="Vacio..." aria-label="Comentario" rows="5"
                                            readonly disabled>{{ $comentario }}</textarea>
                                    </div>
                                </div>
                            </div>
