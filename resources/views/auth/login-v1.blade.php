        ...
        <section>
            <div class="container-login" style="padding: 3% 15%;">
                <div class="page-header min-vh-90"
                    ...
                    <div class="container">
                        {{-- <img decoding="async" class="logo_footer" src="http://localhost:8000/img/logo tu repuesto ya/logo tu repuesto.png" alt="Imagen_TuRepuestoYa" style="height: 50px;"> --}}
                        <div class="row">
                            <div
                                class="animate__animated animate__fadeIn animate__delay-1s animate__faster col-xl-6 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                                <div class="card card-plain">
                                    <div class="card-header pb-0 text-start" style="background-color: transparent;">
                            ...
                            <div
                                ...
                                background-size: cover;">
                                    <span class="mask opacity-6"
                                        style="background-image: linear-gradient(310deg, #06090D 0%, #132340 100%);"></span>
