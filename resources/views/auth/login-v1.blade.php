...
@section('content')
    ...
    <main class="main-content  mt-0">
        <section>
            <div class="container-login contenedor-login flex-col-cel" style="padding: 3% 15%; display: flex;
            justify-content: center;">
                <div class="bg-transparent-cel flex-col-cel page-header"
                    ...
                    <div class="container contenedor-login">
                        <div class="row">
                            <div
                                class="animate__animated animate__fadeIn animate__delay-1s animate__faster col-xl-6 col-lg-6 d-flex flex-column mx-lg-0 mx-auto">
