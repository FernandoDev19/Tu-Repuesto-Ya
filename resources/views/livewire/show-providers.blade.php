                ...
                <thead>
                    <tr>
                        <th class="text-muted" wire:click="order('nit_empresa')"
                            style="cursor: pointer; padding:10px 5px; text-align:center; font-size: 14px;">NIT
                            @if ($sort == 'nit_empresa')
                                @if ($direction == 'asc')
                        ...
                        <th class="text-muted" wire:click="order('nombre_comercial')" style="cursor: pointer; padding: 10px 5px; text-align: center; font-size: 14px;">
                            Nombre Establecimiento
                            @if ($sort == 'nombre_comercial')
                                @if ($direction == 'asc')
                                    <i class="fas fa-sort-alpha-up-alt float-right"></i>
                                @else
                                    <i class="fas fa-sort-alpha-down-alt float-right"></i>
                        ...
                        <th class="text-muted" wire:click="order('razon_social')"
                            style="cursor: pointer; padding:10px 5px; text-align:center; font-size: 14px;">Razón
                            Social @if ($sort == 'razon_social')
                            @if ($direction == 'asc')
                                <i class="fas fa-sort-alpha-up-alt float-right"></i>
                            @else
                                <i class="fas fa-sort-alpha-down-alt float-right"></i>
                        ...
                        <th class="text-muted" wire:click="order('celular')"
                            style="cursor: pointer; padding:10px 5px; text-align:center; font-size: 14px;">
                            Celular @if ($sort == 'celular')
                            @if ($direction == 'asc')
                                <i class="fas fa-sort-alpha-up-alt float-right"></i>
                            @else
                                <i class="fas fa-sort-alpha-down-alt float-right"></i>
                        ...
                        <th class="text-muted" wire:click="order('departamento')"
                            style="cursor: pointer; padding:10px 5px; text-align:center; font-size: 14px;">
                            Departamento @if ($sort == 'departamento')
                            @if ($direction == 'asc')
                                <i class="fas fa-sort-alpha-up-alt float-right"></i>
                            @else
                                <i class="fas fa-sort-alpha-down-alt float-right"></i>
                        ...
                        @foreach ($proveedor as $proveedores)
                            <tr>
                                ...
                                <td style="padding:10px; width: 6vw;" class="text-center">
                                    <a title="Ver detalles" class="btn btn-primary verDetalles" data-toggle="modal"
                ...
                <div class="modal-dialog" role="document" style="z-index: 1042;">
                    <div class="modal-content" style="z-index: 1043;">
                        <div class="modal-header">
                            ...
                            <button class="close" id="btnCloseModalCreate1" type="button" data-dismiss="modal"
                                aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
