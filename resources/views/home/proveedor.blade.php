...
<link rel="stylesheet" type="text/css" href="{{ asset('css/home/styles_for_proveedor.css') }}">
@section('title', 'PROVEEDOR - Tu Respuesto Ya')
@section('content')
            ...
            <div class="collapse navbar-collapse container-op" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto" style="align-items: center">
                    ...
                    <div class="container_nav" id="Cnav3">
                        <li class="nav-item">
                            <p class="nav-link active" id="nav_e">PROVEEDOR</p>
                        </li>
    ...
    <section id="sesion-de-proveedores">

        <article data-aos="fade-right" data-aos-duration="800" class="article_proveedor">
            <div id="contenedor-pro">
                <div id="black">
                    <h1>PROVEEDOR?</h1>
                </div>
                <div class="proveedor">
                    <P>Registra tus datos, atiende el llamado de un WSP y <br>
                        realiza el paso a paso del Chat Bot</P>
                    <a class="registrate" href="{{ route('register') }}">REGISTRATE</a>
                </div>
            </div>
        </article>

        <article data-aos="fade-in" data-aos-duration="800" class="article_info">
            <img class="ico-llave" decoding="async" src="{{ asset('icon/llave-inglesa.png') }}" alt="llave-inglesa">
            <img class="ico-destornillador" decoding="async" src="{{ asset('icon/destornillador.png') }}"
                alt="destornillador">
            <h1>EN <span class="azul">TUREPUESTOYA</span></h1>
            <p>Te brindamos mas clientes de todo el pais facil y rapido.</p>
            <ul id="list_info">
                <li>Registrate con tus datos</li>
                <li>Que repuestos manejas</li>
                <li>Tus cotizaciones</li>
                <li>Donde te ubicas</li>
            </ul>
            <img class="ico-ajustes" decoding="async" src="{{ asset('icon/configuraciones.png') }}" alt="ajustes">
        </article>
