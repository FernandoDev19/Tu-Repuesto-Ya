                                                    ...
                                                    document.addEventListener('DOMContentLoaded', function(){
                                                          ...
                                                          for (let i = 0; i < proveedores.length; i++) {
                                                            if (proveedores[i].id !== {{$proveedores->id}}) {
                                                              if (proveedores[i].nit_empresa === nit.value) {
                                                                errorNit.textContent = 'El NIT ya está registrado';
                                                                return;
                                                              }
                                                            }
                                                          }
                                                        ...
                                                        function razonAndNombreValidity(){
                                                                ...
                                                                for(let i = 0; i < proveedores.length; i++){
                                                                    if(proveedores[i].id != {{$proveedores->id}}){
                                                                        if(proveedores[i].razon_social.toLowerCase() == razonValue.toLowerCase()){
                                                                            ...
                                                                            error_razon.textContent = 'Esta razón social ya está registrada';
                                                                            return;
                                                                        }else{
                                                                            razon.setCustomValidity('');
                                                                            error_razon.textContent = '';
                                                                        }
                                                                    }else{
                                                                        error_razon.textContent = '';
                                                                        razon.setCustomValidity("");
                                                            ...
                                                            if (nombre.value.length != 0) {
                                                                ...
                                                                for(let i = 0; i < proveedores.length; i++){
                                                                    if(proveedores[i].id != {{$proveedores->id}}){
                                                                        if(proveedores[i].razon_social.toLowerCase() == nombreValue.toLowerCase()){
                                                                            ...
                                                                            error_nombre.textContent = 'Este Nomrbe ya está registrado';
                                                                            return;
                                                                        }else{
                                                                ...
                                                                nombre.setCustomValidity("El nombre comercial es obligatorio");
