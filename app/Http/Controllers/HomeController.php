...
class HomeController extends Controller
{
    ...
    public function validation(Request $request): redirectResponse
    {
        ...
        $palabrasClave = [
            'Llantas' => ['Llanta', 'yanta', 'yanta', 'Llantas', 'Neumático', 'Neumáticos', 'Neumaticos', 'Neumatico'],
            'Frenos' => ['Pastillas', 'Pastilla', 'Freno', 'Frenos', 'Discos', 'Disco', 'Tambor', 'Tambores', 'Bombas', 'Bomba', 'Servofreno', 'Bandas', 'Banda'],
            ...
            'Motor' => ['Pistón', 'piston', 'pistones', 'Motores', 'motor', 'Filtros', 'Filtro', 'aceite', 'Filtros de aceite', 'aire', 'Filtros de aire', 'combustible', 'Filtros de combustible', 'bujias', 'bujia', 'bujía', 'Bujías', 'Bobina', 'Bobinas', 'Bobinas de encendido', 'encendido', 'Correa', 'Correas', 'Correas de distribución', 'distribución', 'Bombas', 'Bomba', 'Bomba de agua', 'Bomba de aceite', 'Turbocompresor', 'Alternador', 'Arrancador'],
            ...
            'Refrigeración' => ['Radiador', 'Termostato', 'Ventilador', 'Bomba de Agua', 'Bombas', 'Bomba', 'Agua', 'Refrigeración', 'Refrigerante', 'Manguera de refrigerante', 'Tapa del radiador', 'Sensores', 'Sensor', 'Oxigenos', 'Sensor de oxigeno', 'Sensor de temperatura', 'Temperatura', 'Radiador de aceite'],
