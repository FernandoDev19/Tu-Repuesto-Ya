    ...
    public function validation(Request $request): redirectResponse
    {
        ...
        try {
            ...
            foreach ($proveedores as $proveedor) {
                ...
                if ((is_array($marcasGuardadasArray) && (in_array('Todas las marcas', $marcasGuardadasArray) || in_array($marcaCliente, $marcasGuardadasArray) || in_array($request->marca_otro, $marcasGuardadasArray))) && (is_array($categoriasGuardadasArray) && (in_array('Todas las especialidades', $categoriasGuardadasArray) || ($categoriaRepuesto && array_intersect($categoriaRepuesto, $categoriasGuardadasArray)))) || $request->categoria_repuesto == 'No sé') {
