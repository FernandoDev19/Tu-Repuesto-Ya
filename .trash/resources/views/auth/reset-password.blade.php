                                    ...
                                    <div class="card-body">
                                        <form role="form" method="POST" action="{{ route('emailVerification') }}">
                                            ...
                                            <div class="flex flex-col mb-3">
                                                ...
                                                @else
                                                    <p id="email-error" class="text-danger text-xs pt-1"></p>
                                                @enderror
                                            </div>
            ...
            function emailValidity() {
                ...
                if (emailValue.length !== 0) {
                    for (let i = 0; i < proveedores.length; i++) {
                        if (proveedores[i].email === emailValue || proveedores[i].email_secundario === emailValue) {
                    ...
                    error.textContent = 'El email no está registrado';
                    email.setCustomValidity("El email no está registrado");
                } else {
                    error.classList.add('hide');
                    error.textContent = '';
                    email.setCustomValidity("El campo está vacío");
                }
            }
