...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/my-business', 'index2')->name("mi-empresa");
    Route::get('/providers', 'index3')->name("proveedor");
});
...
Route::middleware(['auth', 'checkProveedor'])->group(function () {
    Route::get('/provider/dashboard', [ProveedorController::class, 'dashboard'])->name('dashboard')->middleware('can:dashboard');
